...
final class ServiceProvider: ServiceProviderType {
    lazy var programScheduleService: ProgramScheduleServiceType = ProgramScheduleService(provider: self)
    lazy var weightCalculationService: WeightCalculationServiceType = WeightCalculationService(provider: self)
}
